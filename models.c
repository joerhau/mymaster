...
{ 
...

  {
	...
	case DAYHOFF:
	  {	
//		  daa[ 1*20+ 0] = 100.0;
//		  daa[ 2*20+ 0] = 100.0; daa[ 2*20+ 1] = 100.0;
//		  daa[ 3*20+ 0] = 100.0; daa[ 3*20+ 1] = 100.0; daa[ 3*20+ 2] = 100.0;
//		  daa[ 4*20+ 0] = 100.0; daa[ 4*20+ 1] = 100.0; daa[ 4*20+ 2] = 100.0; daa[ 4*20+ 3] = 100.0;
//		  daa[ 5*20+ 0] = 100.0; daa[ 5*20+ 1] = 100.0; daa[ 5*20+ 2] = 100.0; daa[ 5*20+ 3] = 100.0; daa[ 5*20+ 4] = 100.0;
//		  daa[ 6*20+ 0] = 100.0; daa[ 6*20+ 1] = 100.0; daa[ 6*20+ 2] = 100.0; daa[ 6*20+ 3] = 100.0; daa[ 6*20+ 4] = 100.0; daa[ 6*20+ 5] = 100.0;
//		  daa[ 7*20+ 0] = 100.0; daa[ 7*20+ 1] = 100.0; daa[ 7*20+ 2] = 100.0; daa[ 7*20+ 3] = 100.0; daa[ 7*20+ 4] = 100.0; daa[ 7*20+ 5] = 100.0; daa[ 7*20+ 6] = 100.0;
//		  daa[ 8*20+ 0] = 100.0; daa[ 8*20+ 1] = 100.0; daa[ 8*20+ 2] = 100.0; daa[ 8*20+ 3] = 100.0; daa[ 8*20+ 4] = 100.0; daa[ 8*20+ 5] = 100.0; daa[ 8*20+ 6] = 100.0; daa[ 8*20+ 7] = 100.0;
//		  daa[ 9*20+ 0] = 100.0; daa[ 9*20+ 1] = 100.0; daa[ 9*20+ 2] = 100.0; daa[ 9*20+ 3] = 100.0; daa[ 9*20+ 4] = 100.0; daa[ 9*20+ 5] = 100.0; daa[ 9*20+ 6] = 100.0; daa[ 9*20+ 7] = 100.0; daa[ 9*20+ 8] = 100.0;
//		  daa[ 10*20+ 0] = 100.0; daa[ 10*20+ 1] = 100.0; daa[ 10*20+ 2] = 100.0; daa[ 10*20+ 3] = 100.0; daa[ 10*20+ 4] = 100.0; daa[ 10*20+ 5] = 100.0; daa[ 10*20+ 6] = 100.0; daa[ 10*20+ 7] = 100.0; daa[ 10*20+ 8] = 100.0; daa[ 10*20+ 9] = 100.0;
//		  daa[ 11*20+ 0] = 100.0; daa[ 11*20+ 1] = 100.0; daa[ 11*20+ 2] = 100.0; daa[ 11*20+ 3] = 100.0; daa[ 11*20+ 4] = 100.0; daa[ 11*20+ 5] = 100.0; daa[ 11*20+ 6] = 100.0; daa[ 11*20+ 7] = 100.0; daa[ 11*20+ 8] = 100.0; daa[ 11*20+ 9] = 100.0; daa[ 11*20+ 10] = 100.0;
//		  daa[ 12*20+ 0] = 100.0; daa[ 12*20+ 1] = 100.0; daa[ 12*20+ 2] = 100.0; daa[ 12*20+ 3] = 100.0; daa[ 12*20+ 4] = 100.0; daa[ 12*20+ 5] = 100.0; daa[ 12*20+ 6] = 100.0; daa[ 12*20+ 7] = 100.0; daa[ 12*20+ 8] = 100.0; daa[ 12*20+ 9] = 100.0; daa[ 12*20+ 10] = 100.0; daa[ 12*20+ 11] = 100.0;
//		  daa[ 13*20+ 0] = 100.0; daa[ 13*20+ 1] = 100.0; daa[ 13*20+ 2] = 100.0; daa[ 13*20+ 3] = 100.0; daa[ 13*20+ 4] = 100.0; daa[ 13*20+ 5] = 100.0; daa[ 13*20+ 6] = 100.0; daa[ 13*20+ 7] = 100.0; daa[ 13*20+ 8] = 100.0; daa[ 13*20+ 9] = 100.0; daa[ 13*20+ 10] = 100.0; daa[ 13*20+ 11] = 100.0; daa[ 13*20+ 12] = 100.0;
//		  daa[ 14*20+ 0] = 100.0; daa[ 14*20+ 1] = 100.0; daa[ 14*20+ 2] = 100.0; daa[ 14*20+ 3] = 100.0; daa[ 14*20+ 4] = 100.0; daa[ 14*20+ 5] = 100.0; daa[ 14*20+ 6] = 100.0; daa[ 14*20+ 7] = 100.0; daa[ 14*20+ 8] = 100.0; daa[ 14*20+ 9] = 100.0; daa[ 14*20+ 10] = 100.0; daa[ 14*20+ 11] = 100.0; daa[ 14*20+ 12] = 100.0; daa[ 14*20+ 13] = 100.0;
//		  daa[ 15*20+ 0] = 100.0; daa[ 15*20+ 1] = 100.0; daa[ 15*20+ 2] = 100.0; daa[ 15*20+ 3] = 100.0; daa[ 15*20+ 4] = 100.0; daa[ 15*20+ 5] = 100.0; daa[ 15*20+ 6] = 100.0; daa[ 15*20+ 7] = 100.0; daa[ 15*20+ 8] = 100.0; daa[ 15*20+ 9] = 100.0; daa[ 15*20+ 10] = 100.0; daa[ 15*20+ 11] = 100.0; daa[ 15*20+ 12] = 100.0; daa[ 15*20+ 13] = 100.0; daa[ 15*20+ 14] = 100.0;
//		  daa[ 16*20+ 0] = 100.0; daa[ 16*20+ 1] = 100.0; daa[ 16*20+ 2] = 100.0; daa[ 16*20+ 3] = 100.0; daa[ 16*20+ 4] = 100.0; daa[ 16*20+ 5] = 100.0; daa[ 16*20+ 6] = 100.0; daa[ 16*20+ 7] = 100.0; daa[ 16*20+ 8] = 100.0; daa[ 16*20+ 9] = 100.0; daa[ 16*20+ 10] = 100.0; daa[ 16*20+ 11] = 100.0; daa[ 16*20+ 12] = 100.0; daa[ 16*20+ 13] = 100.0; daa[ 16*20+ 14] = 100.0; daa[ 16*20+ 15] = 100.0;
//		  daa[ 17*20+ 0] = 100.0; daa[ 17*20+ 1] = 100.0; daa[ 17*20+ 2] = 100.0; daa[ 17*20+ 3] = 100.0; daa[ 17*20+ 4] = 100.0; daa[ 17*20+ 5] = 100.0; daa[ 17*20+ 6] = 100.0; daa[ 17*20+ 7] = 100.0; daa[ 17*20+ 8] = 100.0; daa[ 17*20+ 9] = 100.0; daa[ 17*20+ 10] = 100.0; daa[ 17*20+ 11] = 100.0; daa[ 17*20+ 12] = 100.0; daa[ 17*20+ 13] = 100.0; daa[ 17*20+ 14] = 100.0; daa[ 17*20+ 15] = 100.0; daa[ 17*20+ 16] = 100.0;
//		  daa[ 18*20+ 0] = 100.0; daa[ 18*20+ 1] = 100.0; daa[ 18*20+ 2] = 100.0; daa[ 18*20+ 3] = 100.0; daa[ 18*20+ 4] = 100.0; daa[ 18*20+ 5] = 100.0; daa[ 18*20+ 6] = 100.0; daa[ 18*20+ 7] = 100.0; daa[ 18*20+ 8] = 100.0; daa[ 18*20+ 9] = 100.0; daa[ 18*20+ 10] = 100.0; daa[ 18*20+ 11] = 100.0; daa[ 18*20+ 12] = 100.0; daa[ 18*20+ 13] = 100.0; daa[ 18*20+ 14] = 100.0; daa[ 18*20+ 15] = 100.0; daa[ 18*20+ 16] = 100.0; daa[ 18*20+ 17] = 100.0;
//		  daa[ 19*20+ 0] = 100.0; daa[ 19*20+ 1] = 100.0; daa[ 19*20+ 2] = 100.0; daa[ 19*20+ 3] = 100.0; daa[ 19*20+ 4] = 100.0; daa[ 19*20+ 5] = 100.0; daa[ 19*20+ 6] = 100.0; daa[ 19*20+ 7] = 100.0; daa[ 19*20+ 8] = 100.0; daa[ 19*20+ 9] = 100.0; daa[ 19*20+ 10] = 100.0; daa[ 19*20+ 11] = 100.0; daa[ 19*20+ 12] = 100.0; daa[ 19*20+ 13] = 100.0; daa[ 19*20+ 14] = 100.0; daa[ 19*20+ 15] = 100.0; daa[ 19*20+ 16] = 100.0; daa[ 19*20+ 17] = 100.0; daa[ 19*20+ 18] = 100.0;
//
//		  f[0] = 0.05; f[1] = 0.05; f[2] = 0.05; f[3] = 0.05; f[4] = 0.05; f[5] = 0.05; f[6] = 0.05; f[7] = 0.05; f[8] = 0.05; f[9] = 0.05; f[10] = 0.05; f[11] = 0.05; f[12] = 0.05; f[13] = 0.05; f[14] = 0.05; f[15] = 0.05; f[16] = 0.05; f[17] = 0.05; f[18] = 0.05; f[19] = 0.05;
